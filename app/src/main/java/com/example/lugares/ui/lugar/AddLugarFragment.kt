...
class AddLugarFragment : Fragment() {
    ...
    indicando al compilador que dicha inicialización se realizará más adelante en el
    código. Si intentamos acceder a alguna variable antes de su inicialización obtendremos
    un error del tipo Caused by*/
